...
public class DateUtil {
    ...
    /**
     * 将long 类型转换成String 类型的时间格式
     * @param dateFormat
     * @param millSec
     * @return
     */
    public static String transferUseDateTimeFormatterLongToDate(DateTimeFormatter dateFormat,Long millSec){
        return dateFormat.format(LocalDateTime.ofInstant(Instant.ofEpochMilli(millSec),ZoneId.systemDefault()));
    }
     ...
     * @return
     */
    public static String transferUseSimpleDateFormatLongToDate(String dateFormat,Long millSec){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(transferUseDateTimeFormatterLongToDate(DateUtil.yyyyMMddHHmm_EN,1563782149860L));
    }
}
