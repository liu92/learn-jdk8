...
public class ExcelTool<T> {
    ...
    private void init(int styleFlag){
        ...
        //将其替换成HorizontalAlignment.CENTER
        this.styleHead.setAlignment(HorizontalAlignment.CENTER);// 左右居中
        // 这个修改
        // this.styleHead.setVerticalAlignment(XSSFCellStyle.VERTICAL_CENTER)
        //为 VerticalAlignment.CENTER
        ...
        //低版本已过时 HSSFColor.BLACK.index
        // 现在对应IndexedColors.BLACK.index
        ...
        switch(styleFlag){
            case 1:
                ...
                // 边框的大小
                this.styleBody.setBorderRight(BorderStyle.valueOf((short) 1));
                // 边框的大小
                this.styleBody.setBorderBottom(BorderStyle.valueOf((short) 1));
                break;
            default:
                this.styleBody = this.workbook.createCellStyle();
                // 左右居中ALIGN_CENTER
...
//            if( null == cell)cell = row.createCell(c);
            ...
            // 下边框
            RegionUtil.setBorderBottom(BorderStyle.valueOf((short) 1), cra,sheetCo);
            // 左边框
            RegionUtil.setBorderLeft(BorderStyle.valueOf((short) 1), cra, sheetCo);
            // 有边框
